                ...
                <div id="split">
                    ...
                    <div id="left">
                        <div class="content">
                            ...
                            <logic:iterate  name="L_PPG" id="ppg">
                                    <br><bean:write name="ppg" property="nombrePPG"/>
                                    <html:link action="A_MostrarConsultaPPG.do" paramName="ppg" paramProperty="numeroPPG" paramId="numeroPPG"> Detalles </html:link>
