...
%><html:html>
    ...
    <body>
        <div id="header">
            <div id="title"><bean:message key="V_VistaEstudiante.title"/></div>
            <div id="menu">
                <ul id="nav">
        ...
        <div id="body_wrapper">
            <div id="body">
                <div id="split">
                    ...
                    <div id="right"><ul id="nav"><li><script type="text/javascript">var hb = new HelpBalloon({ dataURL: '//tooltip.do?V=V_VistaEstudiante'});</script></li></ul></div>
