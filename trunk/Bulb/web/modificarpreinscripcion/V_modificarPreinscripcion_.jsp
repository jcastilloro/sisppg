...
%><html:html>
    ...
    <body>
        <div id="header">
            <div id="title"><bean:message key="V_modificarPreinscripcion.title"/></div>
            <div id="menu">
                <ul id="nav">
            ...
            <div id="body">
                ...
                <div class="box1409001"><html:form styleId="F1409001"
                  ...
                  <html:submit styleClass="button"><bean:message key="V_modificarPreinscripcion.label0"/><%-- Modificar Preinscripcion --%></html:submit>
                    ...
                    <div id="right"><ul id="nav"><li><script type="text/javascript">var hb = new HelpBalloon({ dataURL: '//tooltip.do?V=V_modificarPreinscripcion'});</script></li></ul></div>
