...
%><html:html>
    ...
    <body>
        <div id="header">
            <div id="title"><bean:message key="V_LlenarFInscripcion.title"/></div>
            <div id="menu">
                <ul id="nav">
                    <li><html:link action="/A_Pre_GestionarInscripcion.do"><bean:message key="V_LlenarFInscripcion.label1"/><%-- Regresar --%></html:link></li>
                    <li><html:link action="/A_Pre_CerrarSesion.do"><bean:message key="V_LlenarFInscripcion.label2"/><%-- Cerrar Sesion --%></html:link></li>
            ...
            <div id="body">
                ...
                <div class="box1496666"><html:form styleId="F1496666"
                  ...
                  <html:submit styleClass="button"><bean:message key="V_LlenarFInscripcion.label0"/><%-- Ingresar --%></html:submit>
                    ...
                    <div id="right"><ul id="nav"><li><script type="text/javascript">var hb = new HelpBalloon({ dataURL: '//tooltip.do?V=V_LlenarFInscripcion'});</script></li></ul></div>
