 ...
 */
public class AccionesMontarDocumentosInscripcion extends CohesionAction {

    public ActionForward A_Pre_MontarDocumentosInscripcion(ActionMapping mapping, ActionForm form,
            HttpServletRequest request, HttpServletResponse response)
            throws Exception {

        //Salidas
        final String[] SALIDAS = {"V_MontarDocumentosInscripcion",};
    ...
    public ActionForward A_MontarDocumentosInscripcion(
...
//        byte[] fileData = myFile.getFileData();
        String filePath = getServlet().getServletContext().getRealPath("/") + "upload/DocIns";
