 ...
 * 
 */
public class AccionesConsultarEstudiante extends CohesionAction {
    
/**
     * Called by Struts for the execution of action A_Pre_ConsultarEstudiante.
     * 
     ...
     */
    public ActionForward A_Pre_ConsultarEstudiante(ActionMapping mapping, ActionForm  form,
            HttpServletRequest request, HttpServletResponse response)
            throws Exception {

        //Salidas
        final String[] SALIDAS = {"V_ConsultarEstudiante", };
...
/**
    ...
    public ActionForward A_BusquedaEstudiante(ActionMapping mapping, ActionForm  form,
        ...
        //Salidas
        final String[] SALIDAS = {"V_MostrarConsulta", "A_Pre_ConsultarEstudiante", };
        final int SALIDA_0 = 0;
        ...
        Transaction tr = s.beginTransaction();
        try {
            F_ConsultarEstudiante fF_ConsultarEstudiante = (F_ConsultarEstudiante)form;
/* Aqui empieza mi codigo */
            /* Se extraen los elementos del formulario */
            String area = fF_ConsultarEstudiante.getAreaPPG();
            String tutor = fF_ConsultarEstudiante.getTutorPPG();
            String periodo = fF_ConsultarEstudiante.getPeriodoPPG();
            int ano = fF_ConsultarEstudiante.getAnoPPG();
