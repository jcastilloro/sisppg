...
insert into carrera values (8,'0800', 'Ingeniería de Computación');
...
insert into estudiante values (1,'06-39223','Emily','Benitez Perez','V-19718764','3.2','Femenino','Venezolana','07/05/1991');
insert into estudiante values (4,'06-39911','Andrea Lina','Mendoza Ruiz','V-17171171','3.5','Femenino','Venezolana','11/20/1989');
insert into estudiante values (2,'06-39239','Natalya','Blanco Sanz','V-17667212','3.5','Femenino','Venezolana','08/01/1989');
insert into estudiante values (3,'05-37843','Ruben','Perez Sanz','V-19888888','3.0001','Masculino','Venezolana','02/13/1989');
insert into estudiante values (5,'06-40273','Ana Daniela','Lopez Lopez', 'V-17999999','3.4','Femenino','Venezolana','11/23/1988');
insert into estudiante values (6,'06-39123','Leopoldo Luis','Perez Lopez','V-19718765','4.8','Masculino','Venezolana','07/05/1982');
insert into estudiante values (7,'06-39456','María Monica','Guerrero Morales','V-19718761','3.7','Femenino','Venezolana','07/11/1984');
insert into estudiante values (8,'07-41896','Carlos José','Chitty Morales','V-17965308','3.9','Masculino','Venezolana','05/30/1986');
...
insert into usuario values (12,'admin','12345','admin');
insert into usuario values (13,'07-41896','12345','estudiante');
