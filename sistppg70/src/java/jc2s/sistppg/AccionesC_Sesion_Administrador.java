...
//Checking for actors estudiante
        ...
        try {
            ...
            String parameter = request.getParameter("idCarrera");
            if (parameter != null) {
...
//        }
        ...
        Transaction tr = s.beginTransaction();
        try {
            F_Carrera fF_Carrera = (F_Carrera) form;
            ...
            Carrera p;
            boolean guarda = true;
            if (!fF_Carrera.getIdCarrera().equals("")) {
...
//            request.getSession().removeAttribute("Singular");
//            request.getSession().removeAttribute("Datos");
            Carrera p = (Carrera) request.getSession().getAttribute("Singular");
            request.getSession().removeAttribute("Singular");
