<%@ taglib uri="/WEB-INF/struts-bean.tld" prefix="bean"
           ...
           %><html:html>
    <head>
        <title>Gestionar Periodos de Pasantía Larga</title>
                                                ...
                                                <center>
                                                    <logic:notEmpty name="Singular">
                                                        ...
                                                        <html:form styleId="AdmForm"
                                                                   action="/A_insertar_periodo_pasantia_larga.do" method="post" acceptCharset="utf-8">
                                                            <table border="0">
                                                                <tr><td><p id="1840413_C">Nombre</td><td><html:text styleId="1840413" property="periodoPasantiaLarga" size="30" value="${Singular.nombre}" styleClass="validate[required,custom[onlyLetterSp]]"/></td></tr></p>
                                                ...
                                                <center>
                                                    ...
                                                    <logic:notEmpty name="Agregar">
                                                        ...
                                                        <html:form styleId="AdmForm"
                                                                   action="/A_insertar_periodo_pasantia_larga.do" method="post" acceptCharset="utf-8">
                                                            <table border="0">
                                                                <tr><td><p id="1840413_C">Nombre</td><td><html:text styleId="1840413" property="periodoPasantiaLarga" size="30" value="" styleClass="validate[required,custom[onlyLetterSp]]"/></td></tr></p>
