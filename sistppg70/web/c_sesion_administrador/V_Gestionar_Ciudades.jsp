                                    ...
                                    <div class="box1465928" align="center">
                                        ...
                                        <p><p><p>
                                            ...
                                            <logic:notEmpty name="Singular">
                                                <hr>
                                                <html:form
                                                    action="/A_insertar_ciudad.do" method="post">
                                                <table border="0">
                                                    <tr><td><p id="1840413_C">Nombre</td><td><html:text styleId="1840413" property="ciudad" size="30" value="${Singular.nombre}"/></td></tr></p>
                                                    <tr><td><p>Pais</td><td>
                                        ...
                                        <hr>
                                            <html:form
                                                action="/A_insertar_ciudad.do" method="post">
                                                <table border="0">
                                                    <tr><td><p id="1840413_C">Nombre</td><td><html:text styleId="1840413" property="ciudad" size="30" value=""/></td></tr></p>
                                                    <tr><td><p>Pais</td><td>
