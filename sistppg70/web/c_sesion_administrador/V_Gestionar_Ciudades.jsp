<%@ taglib uri="/WEB-INF/struts-bean.tld" prefix="bean"
           ...
           %><html:html>
    <head>
        <title>Gestionar Ciudades</title>
                                ...
                                <div class="content">
                                    ...
                                    <div class="box1465928" align="center">
                                        ...
                                        <p><p><p>
                                            ...
                                            <hr>
                                            <html:form styleId="CiudadesForm"
                                                       action="/A_insertar_ciudad.do" method="post" acceptCharset="utf-8">
                                                <table border="0">
                                                    <tr><td><p id="1840413_C">Nombre</td><td><html:text styleId="1840413" property="ciudad" size="30" value="${Singular.nombre}" styleClass="validate[required,custom[onlyLetterSp]]"/></td></tr></p>
                                                    <tr><td><p>Pais</td><td>
                                                            <html:select styleId="1843493" property="pais" value="${CiudadD.idPais}">
                                                                <logic:iterate id="arrea" collection="${empty L_Paises ? _vacio : L_Paises}">
                                                            <option value="${arrea.idPais}">${arrea.nombre}</option>
                                                        </logic:iterate>
                                                    </html:select>
                                                    </td></tr>

                                                    <html:hidden property="idCiudad" value="${Singular.idCiudad}"/>

                                                    <tr><td><html:link action="/A_eliminar_ciudad.do" onclick="return confirm('¿Esta seguro de que desea borrar el registro?')" >Eliminar</html:link></td><td><html:submit styleClass="button">Modificar<%-- Crear --%></html:submit><p>
                                                        </td></tr>
                                                </table>
                                                ...
                                                <script>
                                                    $(document).ready(function(){
                                                        $("#CiudadesForm").validationEngine('attach');
                                                    });
                                                </script>
                                            ...
                                            <table><th>
                                                    <html:link action="/A_Prep_Gestionar_Ciudades.do" paramName="Agregare"
                                                               paramId="Agregar">Agregar Ciudad</html:link>
                                                </th></table>
                                        ...
                                        <logic:notEmpty name="Agregar">
                                            ...
                                            <html:form styleId="CiudadesForm"
                                                       action="/A_insertar_ciudad.do" method="post" acceptCharset="utf-8">
                                                <table border="0">
                                                    <tr><td><p id="1840413_C">Nombre</td><td><html:text styleId="1840413" property="ciudad" size="30" value="" styleClass="validate[required,custom[onlyLetterSp]]"/></td></tr></p>
                                                    <tr><td><p>Pais</td><td>
                                                            <html:select styleId="1843493" property="pais" value="">
                                                                <logic:iterate id="arrea" collection="${empty L_Paises ? _vacio : L_Paises}">
                                                            <option value="${arrea.idPais}">${arrea.nombre}</option>
                                                        </logic:iterate>
                                                    </html:select>
                                                    </td></tr>
                                                    <html:hidden property="idCiudad" value=""/>
