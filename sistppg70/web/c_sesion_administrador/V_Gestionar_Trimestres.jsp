<%@ taglib uri="/WEB-INF/struts-bean.tld" prefix="bean"
           ...
           %><html:html>
    <head>
        <title>Gestionar Trimestres</title>
                                    ...
                                    <div class="box1465928" align="center">
                                                    ...
                                                    <table class="sortable" width="400px">
                                                        ...
                                                        <tbody>
                                                            <logic:iterate id="dato" collection="${empty Datos ? _vacio : Datos}">
                                                                ...
                                                                <tr onclick="location.href='/sistppg70/A_Prep_Gestionar_Trimestres.do?idTrimestre=${dato.idTrimestre}'" onmouseover="this.style.cursor='pointer'">
                                                                    <td>
                                                                        <center>
                                                                            ${dato.nombre}
                                                                        </center>
                                        ...
                                        <p><p><p>
                                            ...
                                            <html:form styleId="AdmForm"
                                                       action="/A_insertar_trimestre.do" method="post" acceptCharset="utf-8">
                                                <table border="0">
