                                    ...
                                    <div class="box1465928" align="center">
                                                    ...
                                                    <table class="sortable" width="400px">
                                                        ...
                                                        <tbody>
                                                            <logic:iterate id="dato" collection="${empty Datos ? _vacio : Datos}">
                                                                ...
                                                                <tr onclick="location.href='/sistppg70/A_Prep_Gestionar_Departamentos.do?idDepartamento=${dato.idDepartamento}'" onmouseover="this.style.cursor='pointer'">
                                                                    <td>
                                                                        <center>
                                                                            ${dato.nombre}
                                                                        </center>
                                        ...
                                        <p><p><p>
                                            ...
                                            <html:form styleId="AdmForm"
                                                       action="/A_insertar_departamento.do" method="post" acceptCharset="utf-8">
                                                <table border="0">
                                                    <tr><td><p id="1840413_C">Nombre</td><td><html:text styleId="1840413" property="departamento" size="30" value="${Singular.nombre}" styleClass="validate[required,custom[onlyLetterSp]]"/></td></tr></p>
                                        ...
                                        <logic:notEmpty name="Agregar">
                                            ...
                                            <html:form styleId="AdmForm"
                                                       action="/A_insertar_departamento.do" method="post" acceptCharset="utf-8">
                                                <table border="0">
                                                    <tr><td><p id="1840413_C">Nombre</td><td><html:text styleId="1840413" property="departamento" size="30" value="" styleClass="validate[required,custom[onlyLetterSp]]"/></td></tr></p>
