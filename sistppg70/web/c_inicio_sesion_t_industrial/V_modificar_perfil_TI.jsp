...
%><html:html>
    <head>
        <title><bean:message key="V_modificar_perfil_TI.title"/></title>
    ...
    <body>
        <div id="header">
            <div id="title"><bean:message key="V_modificar_perfil_TI.title"/></div>
            <div id="menu">
                <ul id="nav">
                </ul>
            </div>
        ...
        <div id="body_wrapper">
            <div id="body">
                ...
                <div class="box1840560"><html:form
                  ...
                  <html:submit styleClass="button"><bean:message key="V_modificar_perfil_TI.label0"/><%-- Actualizar perfil --%></html:submit>
                </html:form></div>
