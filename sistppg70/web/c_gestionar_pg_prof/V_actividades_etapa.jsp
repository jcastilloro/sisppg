                ...
                <div id="content">
                    ...
                    <div id="body">
                        ...
                        <div id="split">
                            ...
                            <div id="left">
                                <div class="content">
                                    <h1><center><bean:message key="V_actividades_etapa.title"/></center></h1><hr>
                                    ${empty msg ? "" : msg}
                                    <div class="box1465928" align="center">
                                        ...
                                        <html:form
                                            ...
                                            <table border="0">
                                            <tr><th><p id="1840626_C"><label for="1840626"><bean:message key="F_Actividad_Etapa.label0"/><%-- Descripcion: --%></label></th><td><html:textarea styleId="1840626" property="descripcion" cols="60" rows="10"></html:textarea></td></tr></p>
                                            </table>
                                            <hr>
