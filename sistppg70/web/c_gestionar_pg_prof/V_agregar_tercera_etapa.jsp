...
%><html:html>
    <head>
        <title><bean:message key="V_agregar_tercera_etapa.title"/></title>
    ...
    <body>
        <div id="header">
            <div id="title"><bean:message key="V_agregar_tercera_etapa.title"/></div>
            <div id="menu">
                <ul id="nav">
                </ul>
            </div>
            ...
            <div id="body">
                <div id="split">
                    ...
                    <div id="left">
                        <div class="content">
                            ${empty msg ? "" : msg}
                            <div class="box1840596"><html:form styleId="etapa3Form"
                  action="/A_guardar_tercera_etapa.do" method="post">
                  ...
                  <html:submit styleClass="button"><bean:message key="V_agregar_tercera_etapa.label0"/><%-- Continuar --%></html:submit>
                </html:form>
                            <script>
                            $(document).ready(function(){
                                $("#etapa3Form").validationEngine('attach');
                               });
                            </script>
