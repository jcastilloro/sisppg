                    ...
                    <div id="left">
                        <div class="content">
                            ...
                            <div class="box1840560"><html:form
                                    ...
                                    <table borde="0">
                                        <tr><td><p id="1840562_C"><label for="1840562"><bean:message key="F_Tutor_Industrial.label0"/><%-- Nombre: --%></label></td><td><html:text styleId="1840562" property="nombre" size="30"/></td></tr></p>
                                        <tr><td><p id="1840565_C"><label for="1840565"><bean:message key="F_Tutor_Industrial.label1"/><%-- Email: --%></label></td><td><html:text styleId="1840565" property="email" size="30"/></td></tr></p>
                                        <tr><td><p id="1840569_C"><label for="1840569"><bean:message key="F_Tutor_Industrial.label2"/><%-- Cedula: --%></label></td><td><html:text styleId="1840569" property="cedula" size="30"/></td></tr></p>
                                        <tr><td><p id="1840572_C"><label for="1840572"><bean:message key="F_Tutor_Industrial.label3"/><%-- Telefono: --%></label></td><td><html:text styleId="1840572" property="telefono" size="30"/></td></tr></p>
                                        <tr><td><p id="1844840_C"><label for="1844840"><bean:message key="F_Tutor_Industrial.label4"/><%-- Profesi&oacute;n: --%></label></td><td><html:text styleId="1844840" property="profesion" size="30"/></td></tr></p>
                                        <tr><td><p id="1844843_C"><label for="1844843"><bean:message key="F_Tutor_Industrial.label5"/><%-- Direccion: --%></label></td><td><html:textarea styleId="1844843" property="direccion" cols="60" rows="10"></html:textarea></td></tr></p>
                                        <tr><td><p id="1844837_C"><label for="1844837"><bean:message key="F_Tutor_Industrial.label7"/><%-- Departamento: --%></label></td><td><html:text styleId="1844837" property="departamento" size="30"/></td></tr></p>
                                        <tr><td><p id="1844848_C"><label for="1844848"><bean:message key="F_Tutor_Industrial.label8"/><%-- Cargo: --%></label></td><td><html:text styleId="1844848" property="cargo" size="30"/></td></tr></p>
                                        <tr><td><p id="1844834_C"><label for="1844834"><bean:message key="F_Tutor_Industrial.label9"/><%-- Login de sesion: --%></label></td><td><html:text styleId="1844834" property="login" size="30"/></td></tr></p>
                                        <tr><td><p id="1844823_C"><label for="1844823"><bean:message key="F_Tutor_Industrial.label10"/><%-- Password de sesion: --%></label></td><td><html:password styleId="1844823" property="password" size="30"/></td></tr></p>
                                    </table>
                                    <center><html:submit styleClass="button"><bean:message key="V_Agregar_Tutor_I.label0"/><%-- Agregar Tutor --%></html:submit></center>
