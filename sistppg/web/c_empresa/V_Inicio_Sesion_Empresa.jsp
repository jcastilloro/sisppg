...
%><html:html>
    <head>
        <title><bean:message key="V_Inicio_Sesion_Empresa.title"/></title>
    ...
    <body>
        <div id="header">
            <div id="title"><bean:message key="V_Inicio_Sesion_Empresa.title"/></div>
            <div id="menu">
                <ul id="nav">
        ...
        <div id="body_wrapper">
            <div id="body">
                ...
                <div class="box1840980"><html:form
                  action="/A_Inicio_Sesion_Empresa.do" method="post">
                  <p id="1840982_C"><label for="1840982"><bean:message key="F_Inicio_Sesion_Empresa.label0"/><%-- Login: --%></label><html:text styleId="1840982" property="login" size="30"/></p>
                  <p id="1840985_C"><label for="1840985"><bean:message key="F_Inicio_Sesion_Empresa.label1"/><%-- Password: --%></label><html:password styleId="1840985" property="password" size="30"/></p>
