        ...
        <div id="body_wrapper">
            <div id="body">
                ...
                <div class="box1840463"><html:form
                  ...
                  <p id="1840468_C"><label for="1840468"><bean:message key="F_Inscripcion_Pasantia.label1"/><%-- Resumen del Proyecto: --%></label><html:textarea styleId="1840468" property="resumen" cols="60" rows="10"></html:textarea></p>
                  <p id="1840471_C"><label for="1840471"><bean:message key="F_Inscripcion_Pasantia.label2"/><%-- Objetivos Generales: --%></label><html:textarea styleId="1840471" property="objetivos" cols="60" rows="10"></html:textarea></p>
