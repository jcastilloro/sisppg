 ...
 *
 */
public class AccionesConfirmarDocumento extends CohesionAction {
     ...
     */
    public ActionForward A_ConfirmarDocumento(ActionMapping mapping, ActionForm form,
        ...
        try {
            ...
            if (form != null) {
                F_ConfirmarDocumento f_jur = (F_ConfirmarDocumento) form;
                String ruta = f_jur.getRuta();
