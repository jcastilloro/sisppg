 ...
 */
public class AccionesMontarDocumentosC extends CohesionAction {

    public ActionForward A_Pre_MontarDocumentosC(ActionMapping mapping, ActionForm form,
            HttpServletRequest request, HttpServletResponse response)
            throws Exception {

        //Salidas
        final String[] SALIDAS = {"V_MontarDocumentosC",};
    ...
    public ActionForward A_MontarDocumentosC(
