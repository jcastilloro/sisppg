                    ...
                    <div id="left">
                        <div class="content">
                           ...
                           <table align="center">
                                ...
                                <tr><th><html:link action="/A_MostrarConsultaEstudiante.do" paramName="estudiante" paramProperty="carnetE" paramId="carnetE"> <bean:write name="estudiante" property="nombreE"/> </html:link></th><tr>    
	                        </logic:iterate>
                                 </table>
                        </div>
                    </div>
