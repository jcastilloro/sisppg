            ...
            <div id="body">
                ...
                <div id="split">
                  ...
                  <table border="0" width="450px">
                    ...
                    <tr><th><p id="1480471_C"><label for="1480471"><bean:message key="F_PreInscripcion.label8"/><%-- Te graduas --%></label></th><td> <html:checkbox styleId="1480471" property="graduando"/></p></td></tr><br>
                        </table>
                        <br>
                       <table border="0" width="450px">
                    ...
                    <tr><p id="1480484_C"><html:checkbox styleId="1480484" property="tramiteCCTDS"/></p></tr>
                    <table border="0" width="450px">
                    <tr><th><p id="1480491_C"><label for="1480491"><bean:message key="F_PreInscripcion.label10"/><%-- Region del Pais que estaria dispuesto a ir:  --%></label></th><td> <html:text styleId="1480491" property="region" size="30"/></p></td></tr>
                    <tr><th><p id="1480498_C"><label for="1480498"><bean:message key="F_PreInscripcion.label11"/><%-- Estado del Pais: --%></label></th><td> <html:text styleId="1480498" property="estado" size="30"/></p></td></tr>
                    <tr><th><p id="1480502_C"><label for="1480502"><bean:message key="F_PreInscripcion.label12"/><%-- Ciudad --%></label></th><td> <html:text styleId="1480502" property="ciudad" size="30"/></p></td></tr>
                    </table>
