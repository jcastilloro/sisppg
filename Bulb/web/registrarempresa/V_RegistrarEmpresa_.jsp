...
%><html:html>
    ...
    <body>
        <div id="header">
            <div id="title"><bean:message key="V_RegistrarEmpresa.title"/></div>
            <div id="menu">
                <ul id="nav">
                    <li><html:link action="/A_Pre_IniciarSesionEmpresa.do"><bean:message key="V_RegistrarEmpresa.label1"/><%-- A_Pre_IniciarSesion --%></html:link></li>
            ...
            <div id="body">
                <div id="split">
                    ...
                    <div id="left">
                        <div class="content">
                            ${empty msg ? "" : msg}
                <div class="box1503587"><html:form styleId="F1503587"
                  action="/A_RegistrarEmpresa.do" method="post">
                  <p id="1503589_C"><label for="1503589"><bean:message key="F_RegistrarEmpresa.label0"/><%-- Login --%></label><html:text styleId="1503589" property="login" size="30"/></p>
                  <p id="1503592_C"><label for="1503592"><bean:message key="F_RegistrarEmpresa.label1"/><%-- Nombre de la Empresa --%></label><html:text styleId="1503592" property="nombreEmpresa" size="30"/></p>
                  <p id="1503595_C"><label for="1503595"><bean:message key="F_RegistrarEmpresa.label2"/><%-- RIF: --%></label><html:text styleId="1503595" property="rif" size="30"/></p>
                  <p id="1503599_C"><label for="1503599"><bean:message key="F_RegistrarEmpresa.label3"/><%-- Introduzca contrase&ntilde;a --%></label><html:password styleId="1503599" property="password" size="30"/></p>
                  <p id="1503602_C"><label for="1503602"><bean:message key="F_RegistrarEmpresa.label4"/><%-- Confirme su Contrase&ntilde;a --%></label><html:password styleId="1503602" property="confirmarpassword" size="30"/></p>
                  <p id="1503606_C"><label for="1503606"><bean:message key="F_RegistrarEmpresa.label5"/><%-- Telefono --%></label><html:text styleId="1503606" property="telefono" size="30"/></p>
                  <p id="1503609_C"><label for="1503609"><bean:message key="F_RegistrarEmpresa.label6"/><%-- Direcci&oacute;n --%></label><html:text styleId="1503609" property="direccion" size="30"/></p>
                  <p id="1503615_C"><label for="1503615"><bean:message key="F_RegistrarEmpresa.label7"/><%-- Ciudad --%></label><html:text styleId="1503615" property="ciudad" size="30"/></p>
                  <p id="1503622_C"><label for="1503622"><bean:message key="F_RegistrarEmpresa.label8"/><%-- Pais --%></label><html:text styleId="1503622" property="pais" size="30"/></p>
                  ...
                  <html:submit styleClass="button"><bean:message key="V_RegistrarEmpresa.label0"/><%-- Registrar --%></html:submit>
                    ...
                    <div id="right"><ul id="nav"><li><script type="text/javascript">var hb = new HelpBalloon({ dataURL: '//tooltip.do?V=V_RegistrarEmpresa'});</script></li></ul></div>
