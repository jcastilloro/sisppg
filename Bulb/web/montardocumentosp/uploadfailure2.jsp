...
<body>
    ...
    <div id="menu">
        ...
        <ul id="nav">
                    ...
                    <li><html:link action="/A_Pre_MontarDocumentosP.do"><bean:message key="V_GestionarProrroga.label4"/><%-- Regresar --%></html:link></li>
                ...
                <div id="left">
                    ...
                    <div class="content">
                        ...
                        <center>
                            ...
                            <p align="center"><font size="5" color="#000080">El formato del archivo seleccionado no es valido, los formatos validos son jpg y pdf</font></p>
