...
%><html:html>
    ...
    <body>
        <div id="header">
            <div id="title"><bean:message key="V_ModificarDatosEmpresa.title"/></div>
            <div id="menu">
                <ul id="nav">
            ...
            <div id="body">
                ...
                <div class="box1503587"><html:form styleId="F1503587"
                  ...
                  <html:submit styleClass="button"><bean:message key="V_ModificarDatosEmpresa.label0"/><%-- Modificar Datos --%></html:submit>
                    ...
                    <div id="right"><ul id="nav"><li><script type="text/javascript">var hb = new HelpBalloon({ dataURL: '//tooltip.do?V=V_ModificarDatosEmpresa'});</script></li></ul></div>
