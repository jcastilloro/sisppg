...
%><html:html>
    ...
    <body>
        <div id="header">
            <div id="title"><bean:message key="V_GestionarPasantia.title"/></div>
            <div id="menu">
                <ul id="nav">
                    ...
                    <li><html:link action="/A_Pre_VistaEstudiante.do"><bean:message key="V_GestionarPasantia.label2"/><%-- Regresar --%></html:link></li>
        ...
        <div id="body_wrapper">
            <div id="body">
                <div id="split">
                    ...
                    <div id="right"><ul id="nav"><li><script type="text/javascript">var hb = new HelpBalloon({ dataURL: '//tooltip.do?V=V_GestionarPasantia'});</script></li></ul></div>
