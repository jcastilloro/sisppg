...
%><html:html>
    ...
    <body>
        <div id="header">
            <div id="title"><bean:message key="V_AgregarPPG.title"/></div>
            <div id="menu">
                <ul id="nav">
                    <li><html:link action="/A_Pre_GestionarPPG.do"><bean:message key="V_AgregarPPG.label1"/><%-- Regresar --%></html:link></li>
                    <li><html:link action="/A_Pre_CerrarSesion.do"><bean:message key="V_AgregarPPG.label2"/><%-- Cerrar Sesi&oacute;n --%></html:link></li>
        ...
        <div id="body_wrapper">
            <div id="body">
                ...
                <div class="box1388408"><html:form styleId="F1388408"
                  ...
                  <html:submit styleClass="button"><bean:message key="V_AgregarPPG.label0"/><%-- Agregar Plan --%></html:submit>
                </html:form></div>

                        </div>
                    </div>
                    <div id="right"><ul id="nav"><li><script type="text/javascript">var hb = new HelpBalloon({ dataURL: '//tooltip.do?V=V_AgregarPPG'});</script></li></ul></div>
